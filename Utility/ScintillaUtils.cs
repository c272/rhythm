    ...
    public class ScintillaUtils
    {
        ...
        public static void ConfigureAutoComplete()
        {
            ...
            string[] snippets = new string[] 
            {
                ...
                "input.fromFile",
                "output.toFile",
                "output.setConsoleColour",
                "consoleColour",
                "consoleColour.Black",
                "consoleColour.DarkBlue",
                "consoleColour.DarkGreen",
                "consoleColour.DarkCyan",
                "consoleColour.DarkRed",
                "consoleColour.DarkMagenta",
                "consoleColour.DarkYellow",
                "consoleColour.Gray",
                "consoleColour.DarkGray",
                "consoleColour.Blue",
                "consoleColour.Green",
                "consoleColour.Cyan",
                "consoleColour.Red",
